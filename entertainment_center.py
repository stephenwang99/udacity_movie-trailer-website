...
# create the function to get moive's information via omdbapi database by movieid

def getdata(movieid, youtubeid):
    res = requests.get('http://www.omdbapi.com/?i={}&apikey=46f7964d'.format(movieid))
...
galaxy2 = media.Movie(inf[0],inf[1],inf[2],inf[3],inf[4],inf[5])

inf = getdata("tt3470600", "Wm7qEjEny0w")
sing = media.Movie(inf[0],inf[1],inf[2],inf[3],inf[4],inf[5])

inf = getdata("tt0478970", "pWdKf3MneyI")
ant_man = media.Movie(inf[0],inf[1],inf[2],inf[3],inf[4],inf[5])

inf = getdata("tt3501632", "ue80QwXMRHg")
thor3 = media.Movie(inf[0],inf[1],inf[2],inf[3],inf[4],inf[5])

inf = getdata("tt2294629", "FLzfXQSPBOg")
frozen = media.Movie(inf[0],inf[1],inf[2],inf[3],inf[4],inf[5])

inf = getdata("tt3521164", "LKFuXETZUsI")
moana = media.Movie(inf[0],inf[1],inf[2],inf[3],inf[4],inf[5])
